  ...
  return (
   ...
   {/*    <Ionicons name="document-text" size={120} style={styles.logo} /> */}
      <TouchableOpacity style={styles.btn3}>
        <Text style={styles.txtBtn}>Termos de uso</Text>
      </TouchableOpacity>
...
Este documento estabelece os Termos de Uso e a Política de Privacidade aplicáveis ao uso dos serviços oferecidos por [Nome da Empresa/Aplicativo/Website] (doravante referido como "nós" ou "nosso"), em conformidade com as disposições da Lei Geral de Proteção de Dados (LGPD).
...
Data de Última Atualização: [Inserir Data]
